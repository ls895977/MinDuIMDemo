...
/**
 * Created by zb on 2019/10/29.
 * 页面功能:glide 输出指定圆角
 */
public class IMRoundedCornersTransformation extends BitmapTransformation {
    ...
    public IMRoundedCornersTransformation(int radius, int margin) {
     ...
     */
    public IMRoundedCornersTransformation(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    public boolean equals(Object o) {
        return o instanceof IMRoundedCornersTransformation &&
                ((IMRoundedCornersTransformation) o).radius == radius &&
                ((IMRoundedCornersTransformation) o).diameter == diameter &&
                ((IMRoundedCornersTransformation) o).margin == margin &&
                ((IMRoundedCornersTransformation) o).cornerType == cornerType;
    }
